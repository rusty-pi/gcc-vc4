...
(define_expand "epilogue"
  ...
  ""
{
  m68k_expand_epilogue (M68K_EPILOGUE_NORMAL);
  DONE;
})
...
(define_expand "sibcall_epilogue"
  ...
  ""
{
  m68k_expand_epilogue (M68K_EPILOGUE_SIBCALL);
  DONE;
})

;; The handler address overwrites the return address in the frame, so the
;; transfer of control is still an ordinary "rts"; only the epilogue differs.
...
(define_insn_and_split "eh_return_internal"
  ...
  [(const_int 0)]
{
  m68k_expand_epilogue (M68K_EPILOGUE_EH_RETURN);
  DONE;
})
